                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-start gap-3 flex-1 min-w-0">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="grid grid-cols-[1fr_auto_1fr] items-center text-sm mb-1 gap-1">
                            <span className={`truncate text-right ${match.winner === 'A' ? 'font-semibold text-gray-800' : 'text-gray-600'}`}>
                              {teamANames}
                            </span>
                            <span className="text-gray-400 px-2">vs</span>
                            <span className={`truncate ${match.winner === 'B' ? 'font-semibold text-gray-800' : 'text-gray-600'}`}>
                              {teamBNames}
                            </span>
                          </div>
