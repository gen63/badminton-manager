  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-3 space-y-1.5 flex-1 min-w-0">
      <div className="flex flex-col items-center gap-1 mb-1">
        <h3 className="text-sm font-medium text-gray-700 text-center w-full">コート {court.id}</h3>
        {court.isPlaying && (
      ...
      <div className="border border-blue-200 rounded-lg p-2 bg-blue-50 space-y-1">
        {court.teamA[0] ? (
          ...
          <div className="flex items-center justify-center text-gray-400 text-[11px] h-[68px]">未配置</div>
        )}
      </div>
