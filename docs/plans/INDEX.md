...
- `2026-08-13-auto-start-after-assign.md` — 配置後3分での試合自動開始（開始押し忘れ対策）。開始時刻は配置時刻を採用し、`Court.assignedAt` をべき等キーにする（2026-08-19 改訂: 手動「開始」も `assignedAt` を採用して自動開始と揃え、準備中のタイマー表示は削除）
